...
const createStyles = (theme: any) => StyleSheet.create({
  ...
  chatName: { color: (theme.id === "light" || theme.id === "pink") ? "#1a1a1a" : theme.text, fontSize: 17, fontWeight: "600" },
  ...
  lastMessage: { color: (theme.id === "light" || theme.id === "pink") ? "#555555" : theme.textMuted, fontSize: 15, flex: 1, paddingRight: 16 },
  lastMessageUnread: { color: (theme.id === "light" || theme.id === "pink") ? "#000000" : theme.text, fontWeight: "800" },
