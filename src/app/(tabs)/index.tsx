...
const createStyles = (theme: any) => StyleSheet.create({
  ...
  emptyText: { color: theme.text, fontSize: 18, fontWeight: "600", fontFamily: "Josefin Sans", marginTop: 16 },
  emptySubtext: { color: theme.textMuted, fontSize: 14, fontFamily: "Josefin Sans", marginTop: 8 },
  ...
  chatName: { color: (theme.id === "light") ? "#111111" : (theme.id === "pink") ? "#5c0a2e" : theme.text, fontSize: 17, fontWeight: "600", fontFamily: "Josefin Sans" },
  chatNameUnread: { color: (theme.id === "light") ? "#000000" : (theme.id === "pink") ? "#4a0724" : theme.text, fontWeight: "900", fontFamily: "Josefin Sans" },
  chatTime: { color: theme.textMuted, fontSize: 12, fontWeight: "500", fontFamily: "Josefin Sans" },
  messageRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  lastMessage: { color: (theme.id === "light") ? "#444444" : (theme.id === "pink") ? "#9d174d" : theme.textMuted, fontSize: 15, flex: 1, paddingRight: 16, fontFamily: "Josefin Sans" },
  lastMessageUnread: { color: (theme.id === "light") ? "#000000" : (theme.id === "pink") ? "#4a0724" : theme.text, fontWeight: "800", fontFamily: "Josefin Sans" },
  badge: { backgroundColor: "#f23f43", borderRadius: 4, width: 8, height: 8, alignSelf: "center", marginLeft: 8 },
  badgeText: { color: theme.text, fontSize: 12, fontWeight: "bold", fontFamily: "Josefin Sans" },
  ...
  modalTitle: { color: theme.text, fontSize: 20, fontWeight: "bold", fontFamily: "Josefin Sans", marginBottom: 16, textAlign: "center" },
  ...
  chipText: { color: theme.text, fontSize: 14, fontFamily: "Josefin Sans" },
