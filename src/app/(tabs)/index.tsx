...
const createStyles = (theme: any) => StyleSheet.create({
  ...
  chatName: { color: (theme.id === "light") ? "#111111" : (theme.id === "pink") ? "#5c0a2e" : theme.text, fontSize: 17, fontWeight: "600" },
  chatNameUnread: { color: (theme.id === "light") ? "#000000" : (theme.id === "pink") ? "#4a0724" : theme.text, fontWeight: "900" },
  chatTime: { color: theme.textMuted, fontSize: 12, fontWeight: "500" },
  messageRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  lastMessage: { color: (theme.id === "light") ? "#444444" : (theme.id === "pink") ? "#9d174d" : theme.textMuted, fontSize: 15, flex: 1, paddingRight: 16 },
  lastMessageUnread: { color: (theme.id === "light") ? "#000000" : (theme.id === "pink") ? "#4a0724" : theme.text, fontWeight: "800" },
